...
```text
https://ijudge.it.kmitl.ac.th/submissions/592669/overview
```
...
```text
input รับเลขจำนวนเต็มในช่วงA and B
output จำนนวนในช่วงA-Bที่หารdแล้วได้เศษr
```
...
```text
เหมือนวิธีแรก ใช้ลูปหาจน.ที่หารได้เศษที่ต้องการเก็บไว้ในตัวแปร แล้วปริ้นออกมา
...
```text
ใบ้ให็เก็บจำนวนที่เข้าเงท่อนไขในตัวแปลใหม่
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโครงเริ่มต้น เขียนการดำการตั้งแต่ต้นจนจบ
```
