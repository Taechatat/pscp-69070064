...
```text
https://ijudge.it.kmitl.ac.th/submissions/592789/overview
```
...
```text
input คำสตริงอะไรก้ได้
output aeiouมีกี่ตัว
```
...
```text
แผนแรกครับ ใช้เคาท์หาสระ และมีกี่ตัว
```
...
```text
ใบ้เกี่ยวกับการใช้count
```

คุณยังทำอะไรด้วยตนเอง

```text
ขึ้นเริ่มต้นพอหาวิธีใช้เคาท์ได้ก้ทำจนจบ
```
