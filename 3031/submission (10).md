...
```text
https://ijudge.it.kmitl.ac.th/submissions/602788/overview
```
...
```text
input Sพื้นที่ที่น้ำหมึกที่กระจายต่อหนึ่งวินาที Nจำนวนคำขอร้องของคนอื่น x,yพิดกัดแต่ละบรรทัดตามจน.N
output วินาทีที่จะท่วมแต่ละบรรทัด เรียงตามด้านบนก่อนหลัง
```
...
```text
import math รับอินพุตN,S เข้าลูปรับพิกัดตามN จากนั้นนำเข้าศุตรหาค่า ปัดเศษแล้วยัดเข้าลิส ปริ้นลิสออกมา
```
...
```text
เหมือนแผนแรก เพราะสามารถเขียนได้โดยไม่เกิดปัญหาใดๆ
```
