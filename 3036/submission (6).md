...
```text
input เลขช่องที่อยู่ในปีระมิด
output จำนวนช่องเส้นทางที่น้อยที่สุด
```
...
```text
อธิบายจุดสังเกตูบางอย่างเช่น เลขคี่ จะเป็นสามเหลี่ยม หงาย  เลขคู่ จะเป็นสามเหลี่ยม คว่ำ เลขคู่: จำนวนกำแพง  2r - 3  จำนวนกำแพง  2r - 2
```

คุณยังทำอะไรด้วยตนเอง

```text
เริ่มขึ้นโครงสร้างเบื้อง พยายามคิดสูตร
```
