...
```text
Input: คะแนนโหวตรวม/คะแนนที่มากที่สุด
Output: ผลว่าคะแนนมากที่สุดและน้อยที่สุดมีความน่าประหลาดหร์อไม่
```
...
```text
ช่วยแก้สูตรคณิตและอธิบายความเข้าใจ
```

คุณยังทำอะไรด้วยตนเอง

```text
โครงสร้างเบื้องต้นกับสูตรที่ยังมีจุดผิด
```
