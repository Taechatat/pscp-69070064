...
```text
https://ijudge.it.kmitl.ac.th/submissions/592221/overview
```
...
```text
input จำนวนเต็มหนึ่งจำนวน
output เลขที่หาร10ลงตัวทุกตัว
```
...
```text
ใช้ลูปลบ1และหาร10ทีละตัว แล้วใช้endเพื่อเปลี่ยนต่อท้ายเป็นเว้นวรรค
```
...
```text
ใบ้เกี่ยวกับวิธีการคำนวณใช้วิธีแบบไหน
และให้ไปหาวิธีที่ทำให้ออกบบรทัดเดียว
```

คุณยังทำอะไรด้วยตนเอง

```text
เริ่มตันเขียนโครง ตั้งสมการและวิธีคิดคร่าวๆ
```
