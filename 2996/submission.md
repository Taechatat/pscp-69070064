...
```text
input : รับข้อความ
output : เรียงใหม่จากหลังมาหน้าและทำเป็นพิมพ์เล็ก
Constraints : inputมีทั้งพิมพ์ใหญ่และเล็กต้องoutต้องเปลี่ยนเป็นเล็กทั้งหมด
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้[start,stop,step]ในการเรียนสตริงใหม่และ.lowerเปลี่ยนเป็นเล็ก
```
...
```text
ทำไมเลือก case นี้:อยากรู้ว่าทำได้ไหม
```
